    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center">
                ...
                <h1 class="sitename mb-0">Mentor</h1>
            </a>
            ...
            <nav id="navmenu" class="navmenu mx-auto">
                <ul class="d-flex justify-content-center align-items-center gap-4">
                    ...
                    <li><a href="{{ route('test.courses') }}">Courses</a></li>
            ...
            <div class="d-flex align-items-center">
                @if(Auth::guard('web')->check())
                    ...
                    <form id="logout-form" action="{{ route('client.logout') }}" method="POST" class="d-inline">
                        @csrf
                        <button type="submit" class="btn btn-warning text-dark fw-bold">Đăng xuất</button>
                    </form>
                @else
                    <a href="{{ route('client.login') }}" class="btn btn-outline-light fw-bold">Đăng nhập</a>
                @endif
            </div>
